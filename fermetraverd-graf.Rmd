...
```{r}
ui <- fluidPage(
  titlePanel("Þróun á tekjum, fasteignaverði og mannfjölda eftir sveitarfélögum"),
  sidebarLayout(
    sidebarPanel(
...
## Með mannfjölda og búferlafluttningum
```{r}
library(shiny)
library(ggplot2)
library(dplyr)
...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      plotOutput("combinedPlot"),
      textOutput("adfluttir"),
      textOutput("brottfluttir")
    )
  )
)
